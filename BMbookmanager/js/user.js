$('document').ready(function () {
    ...
    // 返回上一个页面的按钮点击事件
    $('.returnPreviousPage').click(function (e) {
        console.log(111111)
        window.history.back();
    });
