$('document').ready(function () {
    ...
    // 创建事件代理,给装书本的 ul 绑定点击事件,提醒登陆,在登陆成功之后取消该事件代理
    $(".ulContainer").on("click.tipLogin", "li", function (event) {
        alert("请先点击右上角登录")
    })
    ...
    if (getQueryString("sid") != null) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // 
                let name = sessionStorage.getItem("libraryReaderName");
                // 取消事件代理
                $(".ulContainer").off("click.tipLogin")
